                                ...
                                <div class="box-body">
                                       ...
                                       <div class="input-group">
                                        ...
                                        ?>
                                          ...
                                          <div class="form-group">
                                        <label>Agency</label>
                                        <select class="form-control" name="i_agency_id">
                                        <?php
                                        $query_agency = mysql_query("select * from agencies");
                                        while($row_agency = mysql_fetch_array($query_agency)){
                                        ?>
                                        <option value="<?= $row_agency['agency_id']?>" <?php if($row_agency['agency_id'] == $row->agency_id){ ?>selected <?php } ?>><?= $row_agency['agency_name'] ?></option>
                                        <?php
                                        }
                                        ?>
                                        </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="password" name="i_password" class="form-control" placeholder="Enter password ..." value="<?= $row->user_password ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Confirm Password</label>
                                            <input required type="password" name="i_confirm_password" class="form-control" placeholder="Enter confirm password ..." value="<?= $row->user_confirm_password ?>"/>
                                        </div>
                                         <div class="form-group">
                                         <label>Images</label>
