                                ...
                                <div class="box-body">
                                       ...
                                       <div class="input-group">
                                        ...
                                        ?>
                                          ...
                                          <div class="form-group">
                                        <label>RDH</label>
                                        <select class="form-control" name="i_leader_id">
                                        <?php
                           
                                        while($row_rdh = mysql_fetch_array($query_rdh)){
                                        ?>
                                        <option value="<?= $row_rdh['user_id']?>" <?php if($row_rdh['user_id'] == $row->leader_id){ ?>selected <?php } ?>><?= $row_rdh['user_name'] ?></option>
                                        <?php
                                        }
                                        ?>
                                        </select>
