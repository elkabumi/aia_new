...
switch ($page) {
	case 'list':
		...
		$query = select();
		$add_button = "rdh.php?page=form";


		include '../views/rdh/list.php';
		get_footer();
	break;
	...
	case 'form':
		...
		$close_button = "rdh.php?page=list";
		...
		if($id){
			...
			$action = "rdh.php?page=edit&id=$id";
		} else{
			...
			$action = "rdh.php?page=save";
		}

		include '../views/rdh/form.php';
		get_footer();
	break;
	...
	case 'save':
		...
		if($i_password != $i_confirm_password){
			...
			header('Location: rdh.php?page=form&err=1');
			...
			header('Location: rdh.php?page=list&did=1');
	...
	case 'edit':
		...
		if($i_password != $i_confirm_password){
			...
			header("Location: rdh.php?page=form&id=$id&err=1");
			...
			header('Location: rdh.php?page=list&did=2');
	...
	case 'delete':
		...
		header('Location: rdh.php?page=list&did=3');
