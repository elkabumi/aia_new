...
switch ($page) {
	case 'list':
		...
		$query = select();
		$add_button = "pbd.php?page=form";


		include '../views/pbd/list.php';
		get_footer();
	break;
	...
	case 'form':
		...
		$close_button = "pbd.php?page=list";
		...
		if($id){
			...
			$action = "pbd.php?page=edit&id=$id";
		} else{
			...
			$action = "pbd.php?page=save";
		}

		include '../views/pbd/form.php';
		get_footer();
	break;
	...
	case 'save':
		...
		if($i_password != $i_confirm_password){
			...
			header('Location: pbd.php?page=form&err=1');
			...
			header('Location: pbd.php?page=list&did=1');
	...
	case 'edit':
		...
		if($i_password != $i_confirm_password){
			...
			header("Location: pbd.php?page=form&id=$id&err=1");
			...
			header('Location: pbd.php?page=list&did=2');
	...
	case 'delete':
		...
		header('Location: pbd.php?page=list&did=3');
